...
$("#modal-1").fireModal({title: 'Perhatikan ini sebelum mengisi hafalan !',
        
  body: "</br>" +
        '1) Bagi yang hafalannya kurang dari 1 Juz Silahkan isi dengan "0 Juz"' + "</br></br>" +
        '2) Bagi yang hafalannya misal:' + '</br>' +
        '"1 Juz setengah"'+ '</br>' +
        '"1 Juz seperempat"'+ '</br>' +
        '"1 Juz tigaperempat"'+ '</br>' +
        'Silahkan dibulatkan menjadi "1 juz"',
});
