...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 mb-5 mb-lg-0 mb-md-0">
                        <h3 class="fw-bold mb-4">
                            Selamat Datang Di Web PSB Online Pondok Informatika
                            Al-Madinah
                        </h3>
        ...
        <main id="main">
            ...
            <!-- ======= About Section ======= -->
            <!-- <section id="regis" class="about section-bg">
                <div class="container" data-aos="fade-up">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Magni facilis facilis repellendus
                                            cum excepturi quaerat praesentium
                                            libre trade
                                        </p>
                                    </div>
                                </li>
            ...
            <!-- ======= Skills Section ======= -->
            <section id="stat" class="skills">
                <div class="container" data-aos="fade-up">
                    <div class="row skills-content">
                        <div class="col-lg-6">
                            <div class="progress">
                                <span class="skill"
                                    >HTML <i class="val">100%</i></span
                                >
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="progress">
                                <span class="skill"
                                    >Photoshop <i class="val">55%</i></span
                                >
                                <div class="progress-bar-wrap">
                                    <div
                                        class="progress-bar"
            ...
            <!-- ======= Counts Section ======= -->
            <section id="announce" class="counts">
                <div class="container" data-aos="fade-up">
                    <div class="row">
