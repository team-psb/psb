                                    ...
                                    <tbody>
                                        ...
                                        " >
                                            ...
                                            <td>
                                                <a
                                                    href="#mymodal"
                                                    data-remote="{{ route('biodatas.show', $score->user->biodataOne->where('academy_year_id', $tahun_ajaran)->first()->id) }}"
                                                    data-toggle="modal"
                                                    data-target="#mymodal"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    @endif
                                                    <a href="{{ route('scoreIq.answer', $score->user_id) }}"
            ...
            <div class="modal-body">
                <form method="GET">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit" formaction="{{ route('scoreIq.filter-reset') }}" class="btn btn-danger">Atur Ulang</button>
