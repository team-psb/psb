...
class BiodataTwoRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'father_id'=>'required|numeric|min:16|max:20',
            'mother'=>'required|string|min:2|max:225',
            'mother_work'=>'required|string|min:2|max:225',
            'mother_id'=>'required|numeric|min:16|max:20',
    ...
    public function messages()
    {
        return [
            ...
            'guardian.required'=>'Nama wali wajib di isi !!!',
            ...
            'father_id.min'=>'NIK ayah minimal 16 karakter',
            'father_id.max'=>'NIK ayah maximal 20 karakter',
            'mother.min'=>'Nama ibu minimal 5 karakter',
            'mother_work.min'=>'Pekerjaan ibu minimal 5 karakter',
            'mother_id.min'=>'NIK ibu minimal 16 karakter',
            'mother_id.max'=>'NIK ibu maximal 20 karakter',
