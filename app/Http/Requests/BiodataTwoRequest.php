...
class BiodataTwoRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'figure_idol' => 'required|string|max:225',
            'chaplain_idol' => 'required|string|max:225',
            'tauhid' => 'required',
            'study_islamic' => 'required|string|max:225',
            'read_book' => 'required|string|max:225',
            'smoker' => 'required',
            'tattoed' => 'required',
            'pray' => 'required',
            'girlfriend' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'father_id.required' => 'No whatsapp ayah wajib di isi !!!',
            'mother.required' => 'Nama ibu wajib di isi !!!',
            'mother_work.required' => 'Pekerjaan ibu wajib di isi !!!',
            'mother_id.required' => 'No whatsapp ibu wajib di isi !!!',
            'parent_income.required' => 'Pendapatan orang tua wajib di isi !!!',
            'child_to.required' => 'Pertanyaan anak ke berapa? wajib di isi !!!',
            'brother.required' => 'Pertanyaan berapa bersaudara wajib di isi !!!',
            'no_guardian.required' => 'Nomor telepon wali/orang tua wajib di isi !!!',
            ...
            'child_to.min' => 'Pertanyaan Anak ke berapa ? di isi minimal 1',
            'child_to.max' => 'Pertanyaan Anak ke berapa ? Tidak bisa diisi lebih dari 100',
